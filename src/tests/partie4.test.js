import { ContractStatus, ClientType, AccidentType, PaymentMethod, OptionType, BeneficiaryRelation, LegalProcedureStatus, LawyerSpecialty, } from "../types/index.js";
...
// ---- Tests Partie 4 ----
export function runPartie4Tests() {
    ...
    const bobAssignedLawyer1 = assignLawyerToProcedure(bobWaterDisputeProcedure, lawyersList, LawyerSpecialty.CIVIL_LAW);
    ...
    const bobAssignedLawyer2 = assignLawyerToProcedure(bobInsuranceProcedure, lawyersList, LawyerSpecialty.INSURANCE_LAW);
