...
export function runPartie3Tests() {
    ...
    const tripAssistance = new ContractOption(1, OptionType.TRIP_ASSISTANCE, "Trip Assistance", "24h/24 Assistance in case of accident while traveling", 25);
    const juridicalProtection = new ContractOption(2, OptionType.JURIDICAL_PROTECTION, "Legal protection", "Legal Assistance taken care of", 15);
    const familyProtection = new ContractOption(3, OptionType.FAMILY_PROTECTION, "Family Protection", "Protection Extension for the family", 35);
